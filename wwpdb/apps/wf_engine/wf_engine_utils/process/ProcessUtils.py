...
class ProcessUtils(object):
    ...
    def findProcesses(self, key, value, op='str_in'):
        ...
        keyList = ['username', 'num_ctx_switches', 'pid', 'connections', 'cmdline', 'create_time', 'memory_info_ex', 'num_fds', 'memory_maps',
                   'cpu_percent', 'terminal', 'ppid', 'cwd', 'nice', 'status', 'cpu_times', 'memory_info', 'threads', 'open_files', 'name',
                   'num_threads', 'exe', 'uids', 'gids', 'memory_percent']
        pidList = []
