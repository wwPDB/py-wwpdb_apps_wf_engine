...
setup(
    ...
    #
    install_requires=['psutil', 'wwpdb.utils.db', 'wwpdb.utils.config'],
    packages=find_packages(exclude=['wwpdb.apps.tests-wf_engine']),
    package_data={
    ...
    data_files = [
        # Data for bootstrap
        ('data/wf_engine', ['wwpdb/apps/wf_engine/wf_engine_utils/test/test-pdb-codes.ids',
